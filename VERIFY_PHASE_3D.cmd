...
setlocal
cd /d "%~dp0"
echo === Kazi Sasa PS_2 - Phase 3D verification ===
...
if errorlevel 1 (
  ...
  echo       Core Phase 3D validation passed. To run parser tests later, use:
...
echo.
echo Phase 3D verification passed.
pause
exit /b 0
:fail
echo.
echo Phase 3D verification failed.
pause
exit /b 1
