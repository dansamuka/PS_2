...
def main():
    ...
    if not any(x in str(feed.get("meta", {}).get("implementation_phase", "")) for x in ["Phase 3B", "Phase 3C", "Phase 3D", "Phase 3E", "Phase 3E"]):
    ...
    if not any(x in str(report.get("implementation_phase", "")) for x in ["Phase 3B", "Phase 3C", "Phase 3D", "Phase 3E", "Phase 3E"]):
